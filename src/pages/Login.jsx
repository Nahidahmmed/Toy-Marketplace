        ...
        <div className="flex h-screen">
            ...
            <div className="w-1/2 flex  items-center justify-center ">
                <div className="p-8 w-[400px] h-[400px] bg-white rounded-lg shadow-lg border-2 border-sky-100">
                    <h2 className="text-3xl text-center font-semibold text-sky-500 mb-6">Login</h2>
                    <form>
                        <div className="mb-6">
                    ...
                    <span className="text-sky-500 font-semibold">Already have a account? <Link to={"/register"} className="ml-2 underline">Register here</Link> </span>
                </div>
            </div>
        </div>
